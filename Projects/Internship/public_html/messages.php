...
echo <<<_END
            ...
            <textarea class='form-control form-control-sm' rows='3' name='text'></textarea>
            <input class='btn btn-primary btn-sm mt-3' data-transition='slide' type='submit' value='Post Message'>
            </form><br>
_END;
